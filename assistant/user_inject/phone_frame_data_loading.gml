...
/*
 ...
 DECLARATIONS:
  - Attack Grid Index overrides
   ...
   - AG_MUNO_ATTACK_COOLDOWN [SEPARATE FEATURE]
   - AG_MUNO_ATTACK_CD_SPECIAL [SEPARATE FEATURE]

  - Window Grid Index overrides
   - AG_MUNO_WINDOW_EXCLUDE
   - AG_MUNO_WINDOW_ROLE
   - AG_MUNO_WINDOW_INVUL [SEPARATE FEATURE]
   - AG_MUNO_WINDOW_CD_SPECIAL [SEPARATE FEATURE]
  ...
  - Hitbox Grid Index overrides
   ...
   - HG_MUNO_OBJECT_LAUNCH_ANGLE [SEPARATE FEATURE]
 ...
 INPUTS:
  - phone.include_stats: bool (Adds a Stats page to frame data)
  - phone.include_custom: bool (Adds a Custom page to frame data)
  - phone.custom_name: string (Name of the Custom data page)
  - phone.phone_attack_index: int (Attack constant for the phone taunt)
  - phone.starting_ag_index: int (where to start adding AG indexes)
  - phone.starting_hg_index: int (where to start adding indexes)
